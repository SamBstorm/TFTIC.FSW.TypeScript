...
window.onload = () => {
    ...
    let json_result = `{"title" : "L'interface, le foure-tout!", "short_intro":"Encore un chapitre vite fait...", "main_content":["Paragraph 1 lorem ipsum","Paragraph 2 lorem ipsum","Paragraph 3 lorem ipsum","Paragraph 4 lorem ipsum"]}`;
    let json_object = JSON.parse(json_result);
    let json_article = json_object;
